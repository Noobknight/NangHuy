...
import jp.co.crypton.spinach.model.Music;

/**
 * Created by huy on 9/15/2016.
 */
public class DownloadMusicAcdapter extends BaseAdapter{
    private ImageLoader imageLoader = ImageLoader.getInstance();

    private Context context;
    private List<ListData> datas;

    public DownloadMusicAcdapter(Context context, List<ListData> result) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(rowView == null){
            ...
            rowView = inflater.inflate(R.layout.row_download_music, null);
            viewHolder.txtTitle = (TextView) rowView.findViewById(R.id.row_download_music_txt);
            viewHolder.iconImage = (ImageView) rowView.findViewById(R.id.row_download_music_image);
